...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    private LayoutAnimationController mLac;//View出现的动画
    ...
    public NormalDialog(Context context) {
        ...
        isTitleShow(false);//显示标题
        bgColor(Color.parseColor("#ffffff"));//
        cornerRadius(5);//圆角

        contentGravity(Gravity.CENTER);//
        contentTextColor(Color.parseColor("#494949"));
        dividerColor(Color.parseColor("#e1e1e1"));
        btnTextSize(16.5f, 16.5f);
        btnTextColor(Color.parseColor("#00aaed"), Color.parseColor("#00aaed"));
        btnPressColor(Color.parseColor("#f5f5f5"));


        this.show(R.style.mystyle);
    ...
    private void init() {
        ...
        mLac = new LayoutAnimationController(animation, 500);
