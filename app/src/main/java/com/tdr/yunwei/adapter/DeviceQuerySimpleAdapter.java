...
import com.tdr.yunwei.activity.NewIdDeviceAddActivity;
 ...
 */
public class DeviceQuerySimpleAdapter extends BaseSimpleAdapter<DeviceBean> {

    DbManager DB;
    String deviceremark;
    ZProgressHUD zProgressHUD;
    String AccessType="";
    public DeviceQuerySimpleAdapter(Activity mActivity, List<DeviceBean> list, DbManager DB) {
...
//图片太大 会崩溃
                if(!bean.getPhoto1().equals("")||!bean.getPhoto2().equals("")
                    ...
                    Intent intent=new Intent(mActivity,NewIdDeviceAddActivity.class);
                    intent.putExtra("DeviceType", mybean.getDeviceType());
