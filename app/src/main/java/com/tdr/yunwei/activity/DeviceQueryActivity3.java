...
import com.tdr.yunwei.adapter.DeviceQuerySimpleAdapter;
 ...
 */
public class DeviceQueryActivity3 extends Activity {
    ...
    private DeviceQuerySimpleAdapter adapter;
                ...
                try {
                    ...
                    if (ErrorCode.equals("0")) {
                        ...
                        if (size == 0) {
                            ...
                            adapter = new DeviceQuerySimpleAdapter(mActivity, deviceBeanList, DB);
