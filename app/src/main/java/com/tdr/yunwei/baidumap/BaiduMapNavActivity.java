 ...
 *
 */
public class BaiduMapNavActivity extends Activity {
	public static final String ROUTE_PLAN_NODE = "routePlanNode";
	private final String TAG = BaiduMapNavActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BaiDuMapDeviceActivity.activityList.add(this);
		createHandler();
	...
	protected void onDestroy() {
		...
		BaiDuMapDeviceActivity.activityList.remove(this);
	}
